...
public class FacebookDataTableStepDefs {
	...
	public void setUp() throws InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver","D:\\Selenium_Bhakti\\Drivers\\chromedriver_win32_B39\\chromedriver.exe");
...
//		driver = new FirefoxDriver();
	...
	public void he_enters_following_data(DataTable table){
		//Initialize data table 
	      ...
	      driver.findElement(By.xpath("abc")).sendKeys(data.get(0).get(0));
	      //reading columns 2nd's values
	      System.out.println(data.get(1).get(1));
	      driver.findElement(By.xpath("abc")).sendKeys(data.get(1).get(1));
	      System.out.println(data.get(2).get(1));
	      driver.findElement(By.xpath("abc")).sendKeys(data.get(2).get(1));
	      System.out.println(data.get(3).get(1));
	      driver.findElement(By.xpath("abc")).sendKeys(data.get(3).get(1));
	      
	      //reading columns 3rd's values
	      System.out.println(data.get(1).get(2));
	      driver.findElement(By.xpath("abc")).sendKeys(data.get(1).get(2));
	      System.out.println(data.get(2).get(2));
	      driver.findElement(By.xpath("abc")).sendKeys(data.get(2).get(2));
	      System.out.println(data.get(3).get(2));
	      driver.findElement(By.xpath("abc")).sendKeys(data.get(3).get(2));
